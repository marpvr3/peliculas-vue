...
async function cargarAPI() {
  try {
    const resGeneros = await fetch(URL_GENEROS)
    generos.value = (await resGeneros.json()).genres || []

    const resPelis = await fetch(URL_POPULARES)
    peliculas.value = (await resPelis.json()).results || []
...
<template>
  <div class="peliculas-container">
    ...
    <section class="filtros text-center mb-4">
    ...
    <div class="container">
      <div class="row g-4">
        <div class="col-6 col-md-4 col-lg-3" v-for="p in peliculasFiltradas" :key="p.id">
          <div class="card-sci position-relative text-center bg-dark p-3 rounded shadow-sm h-100">
